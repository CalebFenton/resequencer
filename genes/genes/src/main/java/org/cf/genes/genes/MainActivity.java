...
public class MainActivity extends Activity {
    ...
    private void callAllMethods() throws Exception {
        ...
        Method someC = MainActivity.class.getMethod("callAllMethods", new Class[] {});
        ...
        ReflectedInvoke.invokeHook(someC, MainActivity.this, new Object[]{});
